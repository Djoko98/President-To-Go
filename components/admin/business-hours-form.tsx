...
export function BusinessHoursForm({ hours }: { hours: BusinessHour[] }) {
  ...
  return (
    <form action={action} className="mt-7 rounded-[30px] bg-white p-5 sm:p-7">
