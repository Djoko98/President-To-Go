  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[#f4f4f2] px-4 py-6">
      <section className="w-full max-w-md rounded-3xl bg-white p-5 shadow-xl sm:rounded-[32px] sm:p-7">
        <Link href="/" aria-label="Nazad na početnu stranu" className="inline-flex items-center gap-3 rounded-2xl">
          <Image src="/brand/president-to-go-logo.png" alt="" width={1024} height={1024} priority className="size-20 rounded-2xl border border-black/5 bg-white object-contain" />
